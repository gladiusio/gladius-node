...
TARGET=/build/gladius-network-gateway.exe SOURCE=/src/gladius-network-gateway/cmd/main.go PROJECT_ROOT=/src/gladius-network-gateway /scripts/go_windows.sh
