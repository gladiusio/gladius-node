...
- Download .dmg from releases: [gladius-0.6.1-macOS.dmg](https://github.com/gladiusio/gladius-node/releases/download/0.6.1/gladius-0.6.1-macOS.dmg)
- Double click and drag the App to your Applications folder

### Windows

- Download .exe from releases: [gladius-0.6.1-windows-setup.exe](https://github.com/gladiusio/gladius-node/releases/download/0.6.1/gladius-0.6.1-windows-setup.exe)
