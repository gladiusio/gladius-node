...
func main() {
	...
	// applyToPool("0xE41aD0A56d340E258A367dF6fAD7813134757842", "0x7663fEE3390C93f4e09a52F7C09680Af7C6591E1")
}
...
func postSettings() {
	...
	res, err := sendRequest("POST", url, localSettings)
	if err != nil {
...
func applyToPool(nodeAddress, poolAddress string) {
